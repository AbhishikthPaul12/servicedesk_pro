  ...
  return (
    ...
    >
      <defs>
        ...
        {/* Spine Gradient (Vertical Pillar) */}
        ...
        {/* Wing / Kick Gradient (Thrust Arrow) */}
      ...
      {/* ==================== "R" MONOGRAM EMBLEM ==================== */}
      {/* 1. Left Foundation Pillar (Vertical Spine) */}
      ...
      {/* 3. Resolution Dynamic Thrust Wing (Lower Kick) */}
      <path
        d="M 45 52 L 69 76"
        fill="none"
      ...
      {/* 4. Inner Precision Spark / Resolution Nexus */}
      <path
